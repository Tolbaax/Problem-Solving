...
|11|[**Minimum Time to Collect All Apples in a Tree**]([https://leetcode.com/problems/same-tree/](https://leetcode.com/problems/minimum-time-to-collect-all-apples-in-a-tree/))|[Solution ✓](https://github.com/Tolbaax/Problem-Solving/blob/master/lib/LeetCode_DailyChallenge_in_2023/January/problems/10-Same%20Tree.dart) | **${\bf{\color\{orange}\{Medium}}}$** |
